// components/modals/RavenkeeperModal.tsx
...
export default function RavenkeeperModal({
  visible,
  players,
  excludedPlayerId,
  selectedPlayerId,
    ...
    <Modal visible={visible} transparent animationType="fade">
      <View style={styles.overlay}>
        <View style={styles.card}>
          <Text style={styles.title}>Ravenkeeper</Text>
          <Text style={styles.subtitle}>Select player to learn their role.</Text>
        ...
        <Modal visible={pickerOpen} transparent animationType="fade">
          <View style={styles.pickerOverlay}>
            <View style={styles.pickerCard}>
              <Text style={styles.pickerTitle}>Select a player</Text>
